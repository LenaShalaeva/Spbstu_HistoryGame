...
public class Game_true_false extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        num = random.nextInt(19);//тут рнадомом генерируется число от 0 до 12 не включая, т.к. пока столько у меня есть в массиве
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){ //строка обороботки ивента - касания кнопки
                    ...
                    handler.postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            num = random.nextInt(19); //заново рандомом выбирает число
